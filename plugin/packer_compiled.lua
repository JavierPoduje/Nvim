...
_G.packer_plugins = {
  ...
  ["nightfox.nvim"] = {
    loaded = true,
    path = "/home/puje/.local/share/nvim/site/pack/packer/start/nightfox.nvim",
  ...
  ["nvim-lsp-installer"] = {
    loaded = true,
    path = "/home/puje/.local/share/nvim/site/pack/packer/start/nvim-lsp-installer",
  ...
  ["zenbones.nvim"] = {
    loaded = true,
    path = "/home/puje/.local/share/nvim/site/pack/packer/start/zenbones.nvim",
